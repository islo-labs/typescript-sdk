# Islo TypeScript Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Fislo-labs%2Ftypescript-sdk)
[![npm shield](https://img.shields.io/npm/v/@islo-labs/sdk)](https://www.npmjs.com/package/@islo-labs/sdk)

The Islo TypeScript library provides convenient access to the Islo APIs from TypeScript.
...
Custom code in `Islo.ts`, `IsloBearerClient.ts`, `index.ts`, `tsconfig.json`, and `custom/` is preserved across regenerations via `.fernignore`.

## Reference

A full reference for this library is available [here](https://github.com/islo-labs/typescript-sdk/blob/HEAD/./reference.md).
