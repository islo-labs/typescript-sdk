...
export declare namespace IsloClient {
...
export class IsloClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<IsloClient.Options>;
    ...
    constructor(options: IsloClient.Options) {
