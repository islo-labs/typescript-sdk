# Reference
## auth
<details><summary><code>client.auth.<a href="/src/api/resources/auth/client/Client.ts">exchangeAccessKey</a>({ ...params }) -> IsloApi.TokenResponse</code></summary>
<dl>
<dd>
