...
export class AuthClient {
     ...
     *
     * @param {IsloApi.TokenRequest} request
    ...
    ): core.HttpResponsePromise<IsloApi.TokenResponse> {
    ...
    private async __exchangeAccessKey(
        request: IsloApi.TokenRequest,
        requestOptions?: AuthClient.RequestOptions,
    ): Promise<core.WithRawResponse<IsloApi.TokenResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as IsloApi.TokenResponse, rawResponse: _response.rawResponse };
        }
