...
export class SnapshotsClient {
     ...
     *
     * @param {IsloApi.ListSnapshotsRequest} request
    ...
    ): core.HttpResponsePromise<IsloApi.PaginatedSnapshotResponse> {
    ...
    private async __listSnapshots(
        request: IsloApi.ListSnapshotsRequest = {},
        requestOptions?: SnapshotsClient.RequestOptions,
    ): Promise<core.WithRawResponse<IsloApi.PaginatedSnapshotResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as IsloApi.PaginatedSnapshotResponse, rawResponse: _response.rawResponse };
        }
    ...
    public createSnapshot(
        ...
        requestOptions?: SnapshotsClient.RequestOptions,
    ): core.HttpResponsePromise<IsloApi.SnapshotResponse> {
    ...
    private async __createSnapshot(
        request: IsloApi.SnapshotCreate,
        requestOptions?: SnapshotsClient.RequestOptions,
    ): Promise<core.WithRawResponse<IsloApi.SnapshotResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as IsloApi.SnapshotResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {IsloApi.GetSnapshotRequest} request
     * @param {SnapshotsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link IsloApi.UnauthorizedError}
     * @throws {@link IsloApi.NotFoundError}
     ...
     *
     * @param {IsloApi.DeleteSnapshotRequest} request
     * @param {SnapshotsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link IsloApi.UnauthorizedError}
     * @throws {@link IsloApi.NotFoundError}
