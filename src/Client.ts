...
import { ComputeClient } from "./api/resources/compute/client/Client.js";
...
export class Islo {
    ...
    protected _compute: ComputeClient | undefined;
    ...
    public get compute(): ComputeClient {
        return (this._compute ??= new ComputeClient(this._options));
    }
